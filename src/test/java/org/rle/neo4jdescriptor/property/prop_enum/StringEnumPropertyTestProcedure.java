...
public class StringEnumPropertyTestProcedure
  extends EnumPropertyTestProcedureBase<DummyStringEnum, String> {

  private static final EnumProperty<String, DummyStringEnum> prop = new EnumProperty<>(
    PropertyKey,
    String.class,
    DummyStringEnum.class
  );

  private static final DummyStringEnum[] correctValues = new DummyStringEnum[] {
    DummyStringEnum.SMALL,
    DummyStringEnum.MEDIUM,
    DummyStringEnum.LARGE,
  };
  ...
  private static final Object[] wrongTypeValues = new Object[] {
    ...
    true,
    new String[0],
    new String[] { DummyStringEnum.SMALL.dbValue() },
  };

  private static final String[] correctTypeWrongEnumValues = new String[] {
    DummyStringEnum.SMALL.dbValue() + "foo",
    DummyStringEnum.MEDIUM.dbValue() + "foo",
    DummyStringEnum.LARGE.dbValue() + "foo",
  };
    ...
    return Arrays
      ...
      .map(o ->
        new TestValueInfo(
          o,
          o.dbValue(),
          CypherUtils.string2Cypher(o.dbValue())
        )
      )
  ...
  @Override
  protected String[] correctTypeWrongEnumValues() {
  ...
  @Override
  protected DummyStringEnum getValueOn(Entity entity) {
    return prop.getValueOn(entity);
  }

  @Override
  protected void setValueOn(Entity entity, DummyStringEnum value) {
    prop.setValueOn(entity, value);
  }

  @Override
  protected boolean compareCodeValues(DummyStringEnum o1, DummyStringEnum o2) {
    return Objects.equals(o1, o2);
  }

  @Override
  protected boolean compareCode2GeneralDbValue(DummyStringEnum o1, Object o2) {
