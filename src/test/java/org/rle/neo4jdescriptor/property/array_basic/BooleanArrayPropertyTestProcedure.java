...
public class BooleanArrayPropertyTestProcedure
  extends PropertyTestProcedureBase<Boolean[], Boolean[]> {

  private static final BooleanArrayProperty prop = new BooleanArrayProperty(
    PropertyKey
  );
  ...
  protected List<TestValueInfo> testValueTriples() {
    return Arrays
      .stream(testValues)
      .map(o ->
        new TestValueInfo(o, o.clone(), CypherUtils.booleanArray2Cypher(o))
      )
