...
public class BooleanArrayPropertyTest extends PropertyTestBase {
  ...
  protected Stream<Class<?>> procedureClasses() {
    return Stream.of(
      BooleanArrayPropertyTestProcedure.class,
      PropertyTestProcedureBase.class
    );
  }
  ...
  protected PropertyDescriptor[] createDifferentTypedPropertyDescriptors(
    ...
    return new PropertyDescriptor[] {
      new BooleanProperty(key, logKey),
  ...
  public void basicPropTests() {
    String[] fails = super.runBasicPropertyTests("BooleanArrayProperty");
