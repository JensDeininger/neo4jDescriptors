...
public class LongArrayPropertyTest extends PropertyTestBase {
  ...
  protected Stream<Class<?>> procedureClasses() {
    return Stream.of(LongArrayPropertyTestProcedure.class);
  }
  ...
  public void basicPropTests() {
    String[] fails = super.runBasicPropertyTests("LongArrayProperty");
