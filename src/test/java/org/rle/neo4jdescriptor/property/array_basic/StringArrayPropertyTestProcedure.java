...
public class StringArrayPropertyTestProcedure
  extends PropertyTestProcedureBase<String[], String[]> {

  private static final StringArrayProperty prop = new StringArrayProperty(
    PropertyKey
  );
  ...
  protected List<TestValueInfo> testValueTriples() {
    return Arrays
      .stream(testValues)
      .map(o ->
        new TestValueInfo(o, o.clone(), CypherUtils.stringArray2Cypher(o))
      )
  ...
  @Override
  protected String[] getValueOn(Entity entity) {
    return prop.getValueOn(entity);
  }

  @Override
  protected void setValueOn(Entity entity, String[] value) {
    prop.setValueOn(entity, value);
  }

  @Override
  protected boolean compareCodeValues(String[] o1, String[] o2) {
    return EqualityUtils.arrayEquals(o1, o2);
  }

  @Override
  protected boolean compareCode2GeneralDbValue(String[] o1, Object o2) {
    if (o1 == null && o2 == null) {
      return true;
    }
    if (o1 == null || o2 == null) {
