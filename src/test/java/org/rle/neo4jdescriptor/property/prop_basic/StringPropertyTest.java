...
public class StringPropertyTest extends PropertyTestBase {
  ...
  protected Stream<Class<?>> procedureClasses() {
    return Stream.of(StringPropertyTestProcedure.class);
  }
  ...
  public void basicPropTests() {
    String[] fails = super.runBasicPropertyTests("StringProperty");
