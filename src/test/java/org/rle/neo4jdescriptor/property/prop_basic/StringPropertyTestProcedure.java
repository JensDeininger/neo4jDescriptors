...
public class StringPropertyTestProcedure
  extends PropertyTestProcedureBase<String, String> {

  private static final StringProperty prop = new StringProperty(PropertyKey);
  ...
  protected List<TestValueInfo> testValueTriples() {
    return Arrays
      .stream(testValues)
      .map(o -> new TestValueInfo(o, o, CypherUtils.string2Cypher(o)))
