...
public class LongPropertyTestProcedure
  extends PropertyTestProcedureBase<Long, Long> {

  private static final LongProperty prop = new LongProperty(PropertyKey);
  ...
  protected List<TestValueInfo> testValueTriples() {
    return Arrays
      .stream(testValues)
      .map(o -> new TestValueInfo(o, o, CypherUtils.long2Cypher(o)))
