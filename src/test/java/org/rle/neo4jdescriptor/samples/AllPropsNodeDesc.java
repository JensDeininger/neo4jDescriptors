...
public class AllPropsNodeDesc extends NodeDescriptor {

  public AllPropsNodeDesc() {
    super();
    initLabelsAndProperties(AllPropsNodeDesc.class);
  }

  @Identifying
  public final LabelDescriptor allPropsLabel = SampleLabelRep.AllProps;
